...
int main() {
  ...
  event_system.RegisterAnimationNotification(Foo);
  event_system.RegisterAnimationNotification(lambda);
  ...
  event_system.RegisterTimeoutNotification(Foo_One);
  event_system.RegisterTimeoutNotification(lambda1);
  event_system.RegisterTimeoutNotification(ExtFunction);
  ...
  event_system.RegisterHarwardInterrupt(a_foo);
  event_system.Execute(Event::kHardwareInterrupt, 0, value);
  event_system.RegisterSoftwareInterrupt(Print);
