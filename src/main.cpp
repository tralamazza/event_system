...
int main() {
  ...
  event_system.Register(Foo);
  event_system.Register(lambda);
  ...
  event_system.Register(Foo_One);
  event_system.Register(lambda1);
  event_system.Register(ExtFunction);
  ...
  event_system.RegisterConst(a_foo);
